...
**Hol tart** *(2026-09-09)*: a váz, a szerepkör-kapu, a **7. Játékkonfiguráció**, a **Modifierek** szerkesztője, az aktivitás-audit és a visszajátszó él (`/admin`, `src/admin/` alatt). Az Áttekintő a napi termékmutatók mellett már méri az app előtérben töltött idejét: ma/7 nap/30 nap/mindenkor, 30 napos történet, valamint a mai nap órás és felhasználónkénti bontása. A 2., 4., 5., 6., 8–12. pont még nincs megírva.

### 1. Áttekintő
DAU / WAU / MAU · új regisztrációk · aktivitások és összes táv naponta · elfoglalt km² · aktív streakek · előtérben töltött app-idő ma / 7 nap / 30 nap / mindenkor · 30 napos történeti diagram · mai órás és felhasználónkénti bontás · Pro-konverzió és lemorzsolódás · konnektor-hibaarány · hibás job-futások.
