...
| 2 | **Hosszú rögzítés stabilitása** | sok km / hosszú idő alatt se lassuljon, ne akadjon | **részben mérve, ok ismert** — a hívásonkénti költség ×5,6-ra nő 8,6 km alatt (az újralátogatott, már bekerített jelöltek miatt, nem a távolság önmagában); a Web Worker már kiveszi a főszálból, a mai Game Loop scenario 2 (25 km, 17 hurok, natív) ezt igazolja is: nincs UI-blokkolás. **Hiányzik:** valódi (nem 100×-os, nem folyamatosan előtérben futó) hosszú terepi validálás ([archive](archive/2026-09-04-terepi-fosszal-meres.md), [terv](terv-2026-09-05-rogzites-hangolas-es-test-lab.md)) |
